...
def test():
	with open('/Users/framierecorp/Downloads/kinetics-skeleton/kinetics_train/fS7mjyukZIo.json', 'r') as f:
		data = json.load(f)
	skeleton = data['data'][0]['skeleton'][0]['pose']
	x_coords = np.array(skeleton[0::2])
	y_coords = np.array(skeleton[1::2])

	# plt.scatter(x_coords, -y_coords)
	# plt.show()

	kinetics_processed_skeleton = "/Users/framierecorp/Downloads/data/Kinetics/kinetics-skeleton/train_data.npy"
	kinetics_processed_labels = "/Users/framierecorp/Downloads/data/Kinetics/kinetics-skeleton/train_label.pkl"
	kinetics_skeleton = np.load(kinetics_processed_skeleton)
	with open(kinetics_processed_labels, 'rb') as f:
		kinetics_labels = pickle.load(f)

	x_coords = np.array(kinetics_skeleton[0, :, 10, :, 0][0])
	y_coords = np.array(kinetics_skeleton[0, :, 10, :, 0][1])
	print("done")
